...
function activarFormulario(programaSeleccionado) {
    ...
    // Si es Detrás del Muro, activamos las opciones de I/P vs Cortesía
    if (eventoActivo.nombre === "Detrás del Muro") {
        ...
        document.getElementById('tipoAsistencia').value = ""; // Obligar a elegir
...
// LOGICA DE CAMBIO EN EL SELECTOR
